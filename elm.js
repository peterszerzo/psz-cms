...
Elm.Main.make = function (_elm) {
   ...
   300,
   300,
   _U.list([A2($Graphics$Collage.move,{ctor: "_Tuple2",_0: -10,_1: 0},A2($Graphics$Collage.filled,clearGrey,A2($Graphics$Collage.ngon,3,75)))]));
   return _elm.Main.values = {_op: _op,main: main,clearGrey: clearGrey};
};
