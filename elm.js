...
Elm.App = Elm.App || {};
Elm.App.Elm = Elm.App.Elm || {};
Elm.App.Elm.Counter = Elm.App.Elm.Counter || {};
Elm.App.Elm.Counter.make = function (_elm) {
   "use strict";
   _elm.App = _elm.App || {};
   _elm.App.Elm = _elm.App.Elm || {};
   _elm.App.Elm.Counter = _elm.App.Elm.Counter || {};
   if (_elm.App.Elm.Counter.values) return _elm.App.Elm.Counter.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   var update = F2(function (action,model) {
      ...
      {case "Increment": return {ctor: "_Tuple2",_0: _U.update(model,{count: model.count + 1}),_1: $Effects.none};
         ...
         default: return {ctor: "_Tuple2",_0: _U.update(model,{message: _p0._0}),_1: $Effects.none};}
   });
   var TestMessage = function (a) {    return {ctor: "TestMessage",_0: a};};
   var Decrement = {ctor: "Decrement"};
   var Increment = {ctor: "Increment"};
   var Model = F2(function (a,b) {    return {count: a,message: b};});
   var view = F2(function (address,model) {
      ...
      _U.list([A2($Html.button,_U.list([A2($Html$Events.onClick,address,Decrement)]),_U.list([$Html.text("-")]))
              ...
              ,A2($Html.div,_U.list([]),_U.list([$Html.text(model.message)]))
              ,A2($Html.button,_U.list([A2($Html$Events.onClick,address,Increment)]),_U.list([$Html.text("+")]))]));
   });
   var init = {ctor: "_Tuple2",_0: {count: 0,message: "Counter"},_1: $Effects.none};
   return _elm.App.Elm.Counter.values = {_op: _op
                                        ,init: init
                                        ,view: view
                                        ,Model: Model
                                        ,Increment: Increment
...
Elm.Main.make = function (_elm) {
   ...
   var _U = Elm.Native.Utils.make(_elm),
   $App$Elm$Counter = Elm.App.Elm.Counter.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var test = Elm.Native.Port.make(_elm).inboundSignal("test",
   "String",
   function (v) {
      return typeof v === "string" || typeof v === "object" && v instanceof String ? v : _U.badPort("a string",v);
   });
   var app = $StartApp.start({init: $App$Elm$Counter.init
                             ,view: $App$Elm$Counter.view
                             ,update: $App$Elm$Counter.update
                             ,inputs: _U.list([A2($Signal.map,function (message) {    return $App$Elm$Counter.TestMessage(message);},test)])});
