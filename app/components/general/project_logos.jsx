	...
	return (
		<svg className={props.className} viewBox="0 0 400 400">
			...
			<g>
				...
				<path fill="none" stroke="#FFFFFF" stroke-width="5.2735" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="
...
export function LiquidLab(props) {
	...
	return (
		<svg className={props.className} viewBox="0 0 400 400">
			...
			<g>
				<path style={noFill} fill="#FFFFFF" d="M131.314,252.77c7.672,19.869,20.423,34.582,35.472,44.824
				...
				<path style={noFill} fill="#FFFFFF" d="M235.387,138.678c10.984,10.656,17.347,23.521,20.2,36.998
	...
	return (
		<svg className={props.className} viewBox="0 0 400 400">
			...
			<g>
				...
				<path fill="#FFFFFF" d="M243.074,244.333h-3.455c0,0,3-38.979,3-68s-6-83.416-6-106s3-69.747,3-69.747h3.455c0,0-3,49.956-3,69.747
					s6,75.536,6,106S243.074,244.333,243.074,244.333z"/>
				<path fill="#FFFFFF" d="M203.618,244.333h3.455c0,0-3-38.979-3-68s6-83.416,6-106s-3-69.747-3-69.747h-3.455c0,0,3,49.956,3,69.747
