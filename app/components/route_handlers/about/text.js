...
I make sites and apps - the full-stack thereof - though my strengths and heart lie in clean, well-factored user interfaces and beautiful, elaborate graphics. I work with and get inspiration from the following technologies: React, Backbone, Marionette, d3.js, three.js, and Sass on the front-end, and Node, Express and Rails behind the scenes. I am also quite interested in coding outside of the browser, from architectural and jewelry design to animation, computational art and natural language processing.
...
You can find me on my bike on the streets of DC, one of its nicer coffee shops, the local React meetup, here and there online. Let's talk!
`;